    ...
    <main className="app-shell">
      <section className="phone">
        {currentScreen === "explore" ? (
          ...
          <HomeScreen onDiscover={goToExplore} onProfile={goToProfile} />
        )}

{currentScreen !== "smartmatch" && <ChatWidget />}

{currentScreen !== "aichat" && currentScreen !== "smartmatch" && (
          <BottomNav
...
function HomeScreen({ onDiscover, onProfile }) {
  ...
  const travelStats = useMemo(() => {
    const totalKm = enrichedFlights.reduce(
  ...
  function addFlight(event) {
    ...
    if (!AIRPORTS[originCode] || !AIRPORTS[destinationCode]) {
      alert(
        "Airport not found. Try CEB, NRT, ICN, DPS, MNL, SIN, HKG, KIX, HND, or BKK.",
      );
      return;
    }
  ...
  const budgetPicks = [
    {
      ...
      country: "Vietnam",
      image:
        "https://images.unsplash.com/photo-1559592413-7cec4d0cae2b?q=80&w=700&auto=format&fit=crop",
    },
    {
      title: "Bohol",
      country: "Philippines",
      image:
        "https://images.unsplash.com/photo-1528181304800-259b08848526?q=80&w=700&auto=format&fit=crop",
    },
    {
      title: "Siargao",
      country: "Philippines",
